      ...
      <section className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          >
            ...
            >
              Discover premium quality products at unbeatable prices. Your perfect shopping experience starts here.
            </motion.p>
            ...
            <>
              {filteredProducts.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-500 text-lg">Try adjusting your search terms or browse our categories</p>
                </motion.div>
              ) : (
                <motion.div 
                  variants={containerVariants}
                ...
                >
                  {filteredProducts.map((product, index) => {
                    const image = product.images?.[0]?.images?.[0] && `http://localhost:3000${product.images[0].images[0]}`;
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-6 h-full flex flex-col">
                          <motion.h3 
                            className="font-bold text-xl mb-2 text-gray-900 line-clamp-2 group-hover:text-blue-600 transition-colors duration-300 h-14 flex items-start"
                          >
                            {product.name}
                          </motion.h3>
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "Handpicked premium products with satisfaction guarantee."
              }
            ].map((feature, index) => (
              <motion.div 
                key={index}
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              Get exclusive offers, new product updates, and shopping tips delivered to your inbox.
            </motion.p>
