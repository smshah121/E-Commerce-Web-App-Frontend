...
<motion.button
  ...
  className="w-full mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-xl text-xl font-semibold shadow-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
...
>
  {isLoading ? (
    ...
    <>
      <AiOutlineShoppingCart className="mr-3 text-2xl" /> Pay Online
    </>
  )}
</motion.button>
          </motion.div>
