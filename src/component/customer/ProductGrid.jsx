            ...
            {filteredProducts.map(product => (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  <h4 className="font-bold text-base text-slate-900 tracking-tight line-clamp-1 group-hover:text-[#6a25eb] transition-colors duration-200 mb-1" title={product.name}>
                    {product.name}
                  </h4>
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 px-4 rounded-xl font-bold text-xs tracking-wide transition-all duration-300 flex items-center justify-center gap-2 ${
                      addedItems.has(product.id)
                        ...
                        : 'bg-slate-900 text-white hover:group-hover:text-gradient-to-r from-blue-600 to-purple-600  shadow-sm group-hover:shadow-md'
                    }`}
                  >
                    {addedItems.has(product.id) ? (
                      <>
